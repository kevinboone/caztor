...
/** A subclass of URLConnection that handles the Keplers protocol.
*/
public class KeplersConnection extends URLConnection
  {
...
============================================================================*/
  public KeplersConnection (URL url) 
    {
    super (url);
    Logger.in();
    Logger.out();
...
============================================================================*/
  ...
  public void connect() 
	...
	{ new X509TrustManager() 
      ...
      if (port == -1) port = KeplersURLStreamHandler.DEFAULT_PORT;
	...
	if (args.length != 5)
	    throw new IOException 
	      ("Incorrect number of data elements in response: expected 4, got " 
		 + args.length);
	contentType = args[4]; 
