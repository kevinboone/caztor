...
public class DownloadsDialog extends JFrame implements DownloadMonitorListener
  ...
  private DownloadsDialog()
    ...
    JButton helpButton = CaztorDialog.createButton ("downloads_help"); 
    ...
    JButton closeButton = CaztorDialog.createButton ("downloads_close"); 
    ...
    JButton clearButton = CaztorDialog.createButton ("downloads_clear"); 
