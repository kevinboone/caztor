...
public class FeedManagerDialog extends JFrame 
  ...
  private FeedManagerDialog()
    ...
    JButton helpButton = CaztorDialog.createButton ("feed_manager_help"); 
    ...
    JButton closeButton = CaztorDialog.createButton ("feed_manager_close"); 
    ...
    JButton updateButton = CaztorDialog.createButton ("feed_manager_update"); 
    ...
    JButton stopButton = CaztorDialog.createButton ("feed_manager_stop"); 
