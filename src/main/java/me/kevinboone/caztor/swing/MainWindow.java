...
public class MainWindow extends JFrame implements ConfigChangeListener
  ...
  private final static ResourceBundle generalBundle = 
    ResourceBundle.getBundle ("me.kevinboone.caztor.bundles.General");
  ...
  private final static ResourceBundle menusBundle = 
    ResourceBundle.getBundle ("me.kevinboone.caztor.bundles.Menus");
...
=========================================================================*/
  public MainWindow ()
    ...
    URL iconURL = getClass().getResource ("/images/caztor.png");
...
=========================================================================*/
  private void handleUnsupportedMime (URL url, String mime, byte[] content)
    ...
    //   if it does, there's not much useful that Caztor can do
