...
You can change most aspects of Caztor's operation using the Settings dialog.
...
If you check the box _Remove emojis from bookmarks_, Caztor will remove
...
using the file picker, Caztor will automatically select the "custom"
theme in the list.
...
when you tell Caztor to stream content rather than downloading it. You should
...
For more information on media support in Caztor, see the 
