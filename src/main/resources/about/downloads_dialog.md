...
The Downloads dialog is the user interface to Caztor's download manager.
Caztor will handle multiple transfers -- documents and streams -- in
...
Caztor removes the partially-downloaded file. If you cancel a streaming
operation, Caztor will terminate the application that was playing the stream.
...
When you exit Caztor with transfers pending, Caztor will warn you,
and ask if you want to cancel them.  

Unlike most web browsers, for reasons of privacy Caztor does not store
information about downloads between sessions. The download manager will always
be empty when you start Caztor.  If you choose specifically to download a file
then, of course, Caztor will not delete it. It will, however, delete files that
