# Caztor's user interface

Caztor's user interface should be familiar if you've ever used a web browser
from the mid-90s. Caztor is deliberately, and unashamedly, old-fashioned.
...
a search string directly into the URL bar. Caztor has to guess at what is a
